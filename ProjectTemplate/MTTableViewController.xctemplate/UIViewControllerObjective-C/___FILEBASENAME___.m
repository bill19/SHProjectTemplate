...
@property (nonatomic,strong) NSArray <<#Class Type#> *>*tableDataSource;
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    <#ModelType#> *model = [self modelForIndexPath:indexPath];
    return cell;
}
...
- (<#ModelType#> *)modelForIndexPath:(NSIndexPath *)indexPath {
...
- (NSArray<<#ModelType#> *> *)tableDataSource {
